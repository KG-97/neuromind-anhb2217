...
const decks: Deck[] = [
  ...
  {
    key: 'cortex-functional-areas',
    label: 'Cortex Functional Areas',
    emoji: '🧠',
    leftHeader: 'Functional Area',
    rightHeader: 'Anatomical Location',
    pairs: [
      { term: 'Primary Motor Cortex (M1)', match: 'Precentral gyrus (anterior to central sulcus)' },
      { term: 'Primary Somatosensory Cortex (S1)', match: 'Postcentral gyrus (posterior to central sulcus)' },
      { term: 'Broca\'s Area (BA 44/45)', match: 'Inferior frontal gyrus (left hemisphere)' },
      { term: 'Wernicke\'s Area (BA 22)', match: 'Posterior superior temporal gyrus (left hemisphere)' },
      { term: 'Primary Auditory Cortex (A1)', match: 'Superior temporal gyrus (Heschl\'s gyri, BA 41/42)' },
      { term: 'Primary Visual Cortex (V1)', match: 'Occipital pole (banks of calcarine sulcus)' },
      { term: 'Frontal Eye Fields (BA 8)', match: 'Posterior frontal, superior to Broca\'s' },
      { term: 'Supplementary Motor Area (SMA)', match: 'Medial surface of superior frontal gyrus' },
      { term: 'Precuneus', match: 'Superior parietal, medial surface' },
    ],
  },
  {
    key: 'thalamic-nuclei',
    ...
    emoji: '🌰',
    leftHeader: 'Nucleus',
    rightHeader: 'Function / Relay',
    pairs: [
      { term: 'Anterior Nucleus', match: 'Memory consolidation; Papez circuit' },
      { term: 'Medial (DM) Nucleus', match: 'Emotion regulation; cognitive integration' },
      { term: 'Ventral Anterior (VA)', match: 'Motor planning and initiation' },
      { term: 'Ventral Lateral (VL)', match: 'Coordination of voluntary movement (cerebellar relay)' },
      { term: 'Ventral Posterolateral (VPL)', match: 'Somatosensory from the body' },
      { term: 'Ventral Posteromedial (VPM)', match: 'Somatosensory from the face; taste' },
      { term: 'Pulvinar', match: 'Visual processing; visuospatial attention' },
      { term: 'Medial Geniculate Nucleus (MGN)', match: 'Auditory relay' },
      { term: 'Lateral Geniculate Nucleus (LGN)', match: 'Visual relay' },
    ],
  },
  {
    key: 'cerebellar-pathways',
    label: 'Cerebellar Pathways',
    emoji: '⚖️',
    leftHeader: 'Division',
    rightHeader: 'Function',
    pairs: [
      { term: 'Cerebrocerebellum (Lateral)', match: 'Voluntary movement planning, precision' },
      { term: 'Spinocerebellum (Paravermis/Vermis)', match: 'Muscle tone regulation, posture, limb coordination' },
      { term: 'Vestibulocerebellum (Flocculonodular)', match: 'Maintenance of balance, vestibulo-ocular reflex (VOR)' },
      { term: 'Superior Cerebellar Peduncle (SCP)', match: 'Main efferent (to midbrain/thalamus)' },
      { term: 'Middle Cerebellar Peduncle (MCP)', match: 'Largest afferent (from pons)' },
      { term: 'Inferior Cerebellar Peduncle (ICP)', match: 'Afferent/Efferent (from/to medulla/spinal cord)' },
    ],
  },
  {
    key: 'cerebellum-anatomy',
    label: 'Cerebellum Anatomy',
    emoji: '🧠',
    leftHeader: 'Structure',
    rightHeader: 'Description / Projection',
    pairs: [
      { term: 'Dentate Nucleus', match: 'Lateral zone projection; largest deep nucleus' },
      { term: 'Interposed Nuclei', match: 'Paravermis projection; Emboliform + Globose' },
      { term: 'Fastigial Nucleus', match: 'Vermis projection; most medial deep nucleus' },
      { term: 'Primary Fissure', match: 'Separates anterior and posterior lobes' },
      { term: 'Horizontal Fissure', match: 'Separates superior and inferior surfaces' },
      { term: 'Posterolateral Fissure', match: 'Separates flocculonodular lobe from posterior lobe' },
      { term: 'SCA (Superior Cerebellar Artery)', match: 'Supplies superior surface and deep nuclei' },
      { term: 'AICA (Anterior Inferior Cerebellar Artery)', match: 'Supplies anterior inferior surface & MCP' },
      { term: 'PICA (Posterior Inferior Cerebellar Artery)', match: 'Supplies posterior inferior surface & tonsils' },
    ],
  }
];
